    ...
    return (
      ...
      <div className="container mx-auto flex flex-col py-10 text-center md:py-10 xl:max-w-2xl space-y-3">
        ...
        <div className="flex flex-wrap justify-center">
          ...
          to=''
            className={`${tabIndex===0 && 'bg-white text-[#9538E2] '} px-8 py-3 m-2 text-lg font-bold rounded-full border border-white  cursor-pointer hover:bg-white hover:text-[#9538E2] hover:border-[#9538E2] duration-150`}
          ...
          to={`wish`}
          className={`${tabIndex===1 && 'bg-white text-[#9538E2]'} px-8 py-3 m-2 text-lg font-bold rounded-full border border-white  cursor-pointer hover:bg-white hover:text-[#9538E2] hover:border-[#9538E2] duration-150`}
            fdprocessedid="jeii8a"
          >
            WishList
          </Link>
